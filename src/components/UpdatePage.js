            ...
            <form>
                <center>
                    ...
                    <div class="mt-10">
                        ...
                        <button type="button" class="text-white bg-[#336f7b] w-40 hover:bg-blue-800 mr-2 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
                            onClick={() => {
                                doUpdate()
                            }
                            }>Update</button>
                        <button type="button" class="text-white bg-[#336f7b] w-40 hover:bg-blue-800 ml-5 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
