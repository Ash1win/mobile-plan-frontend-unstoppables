            ...
            <div className="w-full h-full pt-2 flex flex-col flex-wrap content-center">
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-1  pt-15">
                    ...
                    <div class="grid gap-6 mb-6 md:grid-cols-2 pt-3">
                        ...
                        <button type="submit" class="text-white bg-[#336f7b] hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                            onClick={() => {
                                doCreate()
                            }}>Submit</button>
                        <button type="cancle" class="text-white bg-[#336f7b] hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                            onClick={doReset}>
                            Reset
